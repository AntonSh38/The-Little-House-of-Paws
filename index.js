import{a as d,b as $,S as g,N as v,P as y,K as k}from"./assets/vendor-DZCaUcqS.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function e(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(o){if(o.ep)return;o.ep=!0;const i=e(o);fetch(o.href,i)}})();async function q(){return(await d.get("https://paw-hut.b.goit.study/api/categories")).data}async function A(t,s,e){return(await d.get("https://paw-hut.b.goit.study/api/animals",{params:{page:t,limit:s,categoryId:e}})).data}const j=document.querySelector(".pets-card-list");j.addEventListener("click",t=>{if(t.target.nodeName!=="BUTTON")return;const s=t.target.closest(".pets-card-items"),e=JSON.parse(decodeURIComponent(s.getAttribute("data-animal")));$.create(`
  ...
  `,{onShow:()=>{document.body.style.overflow="hidden"},onClose:()=>{document.body.style.overflow=""}}).show()});const f=document.querySelector(".pets-nav"),h=document.querySelector(".pets-card-list"),l=document.querySelector(".pets-btn-more");let p=1,w=window.innerWidth<1440?8:9,L=null,x=0;q().then(t=>{const s=t.map(e=>`<li class="pets-nav-item" data-id="${e._id}">${e.name}</li>`).join("");f.insertAdjacentHTML("beforeend",s)});u();f.addEventListener("click",t=>{if(t.target.nodeName==="LI"){for(const s of t.target.parentElement.children)s.classList.remove("active");t.target.classList.add("active"),L=t.target.getAttribute("data-id"),h.innerHTML="",p=1,u()}});l.addEventListener("click",()=>{p+=1,u(),l.blur()});function u(){A(p,w,L).then(t=>{U(t.animals),x=t.totalItems,B()})}function B(){x<=p*w?l.classList.add("hide-pets-btn"):l.classList.remove("hide-pets-btn")}function U(t){const s=t.map(e=>`
