import{a as c,S as h,N as f,P as x}from"./assets/vendor-Cv3ODtzV.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(o){if(o.ep)return;o.ep=!0;const i=t(o);fetch(o.href,i)}})();async function y(){return(await c.get("https://paw-hut.b.goit.study/api/categories")).data}async function v(e,s,t){return(await c.get("https://paw-hut.b.goit.study/api/animals",{params:{page:e,limit:s,categoryId:t}})).data}const u=document.querySelector(".pets-nav"),m=document.querySelector(".pets-card-list"),L=document.querySelector(".pets-btn-more");let l=1,w=8,g=null;y().then(e=>{console.log(e);const s=e.map(t=>`<li class="pets-nav-item" data-id="${t._id}">${t.name}</li>`).join("");u.insertAdjacentHTML("beforeend",s)});u.addEventListener("click",e=>{if(e.target.nodeName==="LI"){for(const s of e.target.parentElement.children)s.classList.remove("active");e.target.classList.add("active"),g=e.target.getAttribute("data-id"),m.innerHTML="",l=1,p()}});p();L.addEventListener("click",()=>{l+=1,p()});function p(){v(l,w,g).then(e=>{E(e.animals),e.total})}function E(e){const s=e.map(t=>`
   ...
   <div class="swiper-slide about-slide">
    <picture>
      ...
      <!-- мобілка -->
      <source media="(min-width: 320px)" srcset="img/about/mobile-photo/mobile1x-photo${e}.jpg 1x,
       ./img/about/mobile-photo/mobile2x-photo${e}.jpg 2x">
