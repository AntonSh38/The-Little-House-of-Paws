import{a as f,i as m,b as S,S as x,N as k,P as $,K as I,R as T}from"./assets/vendor-DvvmSQtX.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function t(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=t(s);fetch(s.href,n)}})();async function M(){return(await f.get("https://paw-hut.b.goit.study/api/categories")).data}async function P(e,o,t){return(await f.get("https://paw-hut.b.goit.study/api/animals",{params:{page:e,limit:o,categoryId:t}})).data}function D(){const e=document.querySelector(".backdrop-order").innerHTML,o=S.create(e,{onShow:r=>{r.element().querySelector(".modal-order-close").addEventListener("click",()=>r.close()),document.body.style.overflow="hidden",document.addEventListener("keydown",t)},onClose:r=>{document.body.style.overflow="",document.removeEventListener("keydown",t)}});function t(r){r.key==="Escape"&&o.close()}o.show()}const q=document.querySelector(".backdrop-order"),_=document.querySelector(".modal-order-close"),d=document.querySelector(".modal-form");function A(){d.reset(),d.querySelectorAll(".error").forEach(e=>{e.classList.remove("error")})}_.addEventListener("click",()=>{q.style.display="none",document.body.classList.remove("modal-open"),A()});d.addEventListener("submit",e=>{e.preventDefault();const o=d.querySelector('[name="name"]'),t=d.querySelector('[name="phone"]'),r=d.querySelector('[name="comment"]');o.classList.remove("error"),t.classList.remove("error");const s=o.value.trim(),n=t.value.trim();if(!s||!n){s||o.classList.add("error"),n||t.classList.add("error"),m.error({message:"Будь ласка, заповніть ім'я та номер телефону!",position:"topRight",timeout:3e3,zindex:999999,appendTo:document.body});return}console.log("Відправляємо:",{name:s,phone:n,comment:r.value}),A(),q.style.display="none",document.body.classList.remove("modal-open"),m.success({title:"Успіх",message:"Ваша заявка надіслана!",position:"topRight",timeout:3e3,zindex:999999,appendTo:document.body})});d.querySelectorAll("input, textarea").forEach(e=>{e.addEventListener("input",()=>{e.value.trim()&&e.classList.remove("error")})});const F=document.querySelector(".pets-card-list");F.addEventListener("click",e=>{if(e.target.nodeName!=="BUTTON")return;const o=e.target.closest(".pets-card-items"),t=JSON.parse(decodeURIComponent(o.getAttribute("data-animal"))),r=S.create(`
  ...
  `,{closable:!0,onShow:n=>{n.element().querySelector(".modal-pet-btn-close").addEventListener("click",()=>n.close()),document.body.style.overflow="hidden",document.addEventListener("keydown",s),n.element().querySelector(".modal-pet-btn").addEventListener("click",()=>{n.close(),D()})},onClose:()=>{document.body.style.overflow="",document.removeEventListener("keydown",s)}});function s(n){n.key==="Escape"&&r.close()}r.show()});const C=document.querySelector(".loader");function j(){C.classList.remove("is-hidden")}function O(){C.classList.add("is-hidden")}const R=document.querySelector(".pets-nav"),H=document.querySelector(".pets-card-list"),b=document.querySelector(".pets-btn-more");let g=1,U=window.innerWidth<1440?8:9,B=null,N=0;V();w();R.addEventListener("click",e=>{if(e.target.nodeName==="LI"){for(const o of e.target.parentElement.children)o.classList.remove("active");e.target.classList.add("active"),B=e.target.getAttribute("data-id"),H.innerHTML="",g=1,w()}});b.addEventListener("click",()=>{g+=1,w(),b.blur()});async function V(){try{const o=(await M()).map(t=>`<li class="pets-nav-item" data-id="${t._id}">${t.name}</li>`).join("");R.insertAdjacentHTML("beforeend",o)}catch{m.error({title:"",message:"Наші пухнастики сперечаються, хто буде в якій категорії 😸. Повернемо їх незабаром!",position:"topRight"})}}async function w(){try{j();const e=await P(g,U,B);K(e.animals),N=e.totalItems,z()}catch{m.error({title:"",message:"Ой! Наші пухнастики сховалися 🐾. Спробуйте оновити сторінку або поверніться пізніше.",position:"topRight"})}finally{O()}}function z(){N<=g*U?b.classList.add("hide-pets-btn"):b.classList.remove("hide-pets-btn")}function K(e){const o=e.map(t=>`
 ...
 `);document.querySelector(".swiper-wrapper").innerHTML=J.join("");new x(".about-js",{modules:[k,$,I],loop:!1,slidesPerView:1,spaceBetween:30,keyboard:{enabled:!0,onlyInViewport:!0,pageUpDown:!0},wrapperClass:"swiper-wrapper-about",slideClass:"about-slide",navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination-about",clickable:!0}});document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelectorAll(".accordion-item");e.forEach(o=>{const t=o.querySelector(".accordion-title"),r=o.querySelector("svg use"),s=o.nextElementSibling,n=[t,o.querySelector("svg")];s.style.maxHeight=null,n.forEach(i=>{i.addEventListener("click",()=>{const y=s.style.maxHeight&&s.style.maxHeight!=="0px";document.querySelectorAll(".accordion-content").forEach(p=>{p.style.maxHeight=null}),e.forEach(p=>{const c=p.querySelector("svg use");c&&c.setAttribute("href","./icon/sprite.svg#icon-icon-add"),p.classList.remove("open")}),y||(s.style.maxHeight=s.scrollHeight+"px",r&&r.setAttribute("href","./icon/sprite.svg#icon-icon-close"),o.classList.add("open"))})})})});const W="https://paw-hut.b.goit.study/api";f.defaults.baseURL=W;async function G(){var e;try{const{data:o}=await f.get("/feedbacks",{params:{page:1,limit:15}});return o}catch(o){if(o.response){const t=((e=o.response.data)==null?void 0:e.message)||`Помилка сервера: ${o.response.status}`;throw new Error(t)}else throw o.request?new Error("Не вдалося з'єднатися з сервером. Перевірте інтернет-з'єднання"):new Error("Помилка при відправці запиту")}}const Q=document.querySelector(".swiper-wrapper-story");let E=null;function X(e){const o=e.map(({rate:t,description:r,author:s})=>`<div class="swiper-slide swiper-slide-story" role="listitem">
                <div class="story-card">
                   <div class="story-rating" data-rate="${t}"></div>
                  <p class="story-review">${r}</p>
                  <p class="story-author">${s}</p>
                </div>
              </div>`).join("");Q.innerHTML=o}function Z(){const e=document.querySelectorAll(".story-rating");!e||e.length===0||e.forEach(o=>{if(o.classList.contains("jq-ry-container"))return;const t=o.dataset.rate;let r=Number(String(t).replace(",","."));Number.isNaN(r)&&(r=0),r<0&&(r=0),r>5&&(r=5);try{new T(o,{rating:r,starWidth:"21px",halfStar:!0,precision:2,readOnly:!0,normalFill:"#E0E0E0",ratedFill:"#c3b49d",spacing:"6px"}),o.setAttribute("role","img"),o.setAttribute("aria-label",`Рейтинг ${r} з 5`)}catch(s){console.error("❌ RateYo init failed",o,s)}})}function ee(){return E=new x(".swiper-story",{modules:[k,$],slidesPerView:1,spaceBetween:32,wrapperClass:"swiper-wrapper-story",slideClass:"swiper-slide-story",navigation:{nextEl:".story-button-next",prevEl:".story-button-prev"},pagination:{el:".swiper-pagination-story",type:"bullets",dynamicBullets:!0,dynamicMainBullets:4},breakpoints:{768:{slidesPerView:2},1440:{slidesPerView:2}}}),E}function h(e){m.error({title:"Помилка",message:e,position:"topRight",timeout:5e3,closeOnClick:!0,pauseOnHover:!0,progressBar:!0})}async function te(){try{j();const e=await G();if(e&&e.feedbacks&&e.feedbacks.length>0){if(e.feedbacks.length<3){h("Недостатньо відгуків для відображення");return}X(e.feedbacks),Z(),ee()}else h("Не вдалося завантажити відгуки")}catch{h("Сталася помилка при завантаженні відгуків")}finally{O()}}te();document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".mobile-menu-btn"),o=document.querySelector(".mobile-menu-close"),t=document.getElementById("mobileMenu"),r=document.querySelector(".header-btn"),s=document.querySelector(".header"),n=document.querySelector('.mobile-nav-btn, .mobile-nav a[href="#pets"]'),i=a=>{if(!a)return!1;const l=getComputedStyle(a).position;return l==="sticky"||l==="fixed"},y=()=>i(s)?s.offsetHeight:0,p=()=>{t&&(t.classList.add("active"),t.setAttribute("aria-hidden","false"),document.body.style.overflow="hidden")},c=()=>{t&&(t.classList.remove("active"),t.setAttribute("aria-hidden","true"),document.body.style.overflow="")},v=a=>{const l=document.getElementById(a);if(!l)return;const u=window.pageYOffset+l.getBoundingClientRect().top-y();window.scrollTo({top:u,behavior:"smooth"})};e==null||e.addEventListener("click",p),o==null||o.addEventListener("click",c),t==null||t.addEventListener("click",a=>{a.target===t&&c()}),document.addEventListener("keydown",a=>{a.key==="Escape"&&(t!=null&&t.classList.contains("active"))&&c()}),r==null||r.addEventListener("click",a=>{a.preventDefault(),v("pets")}),n==null||n.addEventListener("click",a=>{a.preventDefault(),c(),v("pets")}),document.querySelectorAll('a[href^="#"]').forEach(a=>{a.addEventListener("click",l=>{const u=a.getAttribute("href"),L=u==null?void 0:u.slice(1);L&&(l.preventDefault(),c(),v(L))})})});
